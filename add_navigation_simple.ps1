...
try {
    ...
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-douxu\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-代序\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《我怎么做起小说来》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"daixu.html\"," + "`n"
    $indexGamesJs += "        order: 1" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-yijianxiaoshi\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-一件小事\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《一件小事》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"yijianxiaoshi.html\"," + "`n"
    $indexGamesJs += "        order: 2" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-kongyiji\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-孔乙己\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《孔乙己》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"kongyiji.html\"," + "`n"
    $indexGamesJs += "        order: 3" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-yao\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-药\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《药》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"yao.html\"," + "`n"
    $indexGamesJs += "        order: 4" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-mintian\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-明天\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《明天》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"mintian.html\"," + "`n"
    $indexGamesJs += "        order: 5" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-shexi\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-社戏\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《社戏》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"shexi.html\"," + "`n"
    $indexGamesJs += "        order: 6" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-guxiang\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-故乡\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《故乡》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"guxiang.html\"," + "`n"
    $indexGamesJs += "        order: 7" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-xingfudejiating\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-幸福的家庭\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《幸福的家庭》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"xingfudejiating.html\"," + "`n"
    $indexGamesJs += "        order: 8" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-shansi\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-伤逝\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《伤逝》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"shansi.html\"," + "`n"
    $indexGamesJs += "        order: 9" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-lihun\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-离婚\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《离婚》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"lihun.html\"," + "`n"
    $indexGamesJs += "        order: 10" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-gaolaofuzi\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-高老夫子\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《高老夫子》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"gaolaofuzi.html\"," + "`n"
    $indexGamesJs += "        order: 11" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-bengyue\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-奔月\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《奔月》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"bengyue.html\"," + "`n"
    $indexGamesJs += "        order: 12" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-butian\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-补天\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《补天》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"butian.html\"," + "`n"
    $indexGamesJs += "        order: 13" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-caiwei\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-采薇\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《采薇》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"caiwei.html\"," + "`n"
    $indexGamesJs += "        order: 14" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-zhujian\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-铸剑\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《铸剑》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"zhujian.html\"," + "`n"
    $indexGamesJs += "        order: 15" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-qishi\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-起死\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《起死》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"qishi.html\"," + "`n"
    $indexGamesJs += "        order: 16" + "`n"
    $indexGamesJs += "    }," + "`n"
    $indexGamesJs += "    {" + "`n"
    $indexGamesJs += "        id: \"luxun-huaijiu\"," + "`n"
    $indexGamesJs += "        name: \"鲁迅小说-怀旧\"," + "`n"
    $indexGamesJs += "        description: \"鲁迅小说《怀旧》的交互式游戏\"," + "`n"
    $indexGamesJs += "        path: \"huaijiu.html\"," + "`n"
    $indexGamesJs += "        order: 17" + "`n"
    $indexGamesJs += "    }" + "`n"
    $indexGamesJs += "];"
